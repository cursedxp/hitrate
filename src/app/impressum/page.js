        ...
        <div className="prose prose-lg dark:prose-invert">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              timeliness of the content. Any content that violates applicable
              laws will be removed immediately upon notification.
            </p>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
              Liability for Links
            </h3>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              The protection of our users' personal data is very important to
              us. For detailed information about how we collect, process, and
              store personal data, please refer to our{" "}
              <Link
                href="/privacy"
                className="text-blue-600 dark:text-blue-400 hover:underline"
              >
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              use outside the scope of copyright law requires the written

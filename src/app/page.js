  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center bg-white w-full h-screen">
        ...
        {/* FAQ Section */}
        <section className="flex flex-col gap-2 items-center w-full max-w-7xl justify-center pb-32">
          <h2 className="text-6xl text-black text-center mb-6">
            Quick answers for you.
          </h2>
          <p className="text-xl text-gray-500 text-center mb-12">
            We know you are in a hurry, so we have prepared some quick answers
            for you.
          </p>
